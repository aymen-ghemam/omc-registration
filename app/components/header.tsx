...
const Header = () => {
  ...
  return (
    <div className="relative w-full ">
      ...
      <h1>The Call for New Wizards Begins!</h1>
      <p>Step into a world where technology meets magic
Our mission to share knowledge, spark creativity, and bring students together through open source and scientific events.</p>
      </div>
      </div>
    </div>
  );
